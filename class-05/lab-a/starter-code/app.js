...
function sum(a, b) { //eslint-disable-line
    var sum = a + b;
    console.log(sum);
    var con = 'The sum of ' + a + ' and ' + b + ' is ' + sum + '.';
    return [sum, con]
...
var pro = a * b;
console.log(pro);
var cons = 'The product of ' + a + ' and ' + b + ' is ' + pro + '.';
return [pro, cons]
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var add = sum(sum(a, b)[0], c);
  var mul = multiply(multiply(a, b)[0], c);
  var ans1 = a + ' and ' + b + ' and ' + c + ' sum to ' + add[0] + '.';
